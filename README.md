...
+=====+====================+===============+=========+====================================+
|   1 | Rooftop Lights     | Indigo Parade |    0.99 | - genre match (+0.35)              |
|     |                    |               |         |   - mood match (+0.30)             |
|     |                    |               |         |   - energy closeness (+0.20)       |
|     |                    |               |         |   - tempo closeness (+0.10)        |
|     |                    |               |         |   - acousticness closeness (+0.05) |
+-----+--------------------+---------------+---------+------------------------------------+
|   2 | Sunrise City       | Neon Echo     |    0.63 | - mood match (+0.30)               |
|     |                    |               |         |   - energy closeness (+0.19)       |
|     |                    |               |         |   - tempo closeness (+0.10)        |
|     |                    |               |         |   - acousticness closeness (+0.04) |
+-----+--------------------+---------------+---------+------------------------------------+
|   3 | Night Drive Loop   | Neon Echo     |    0.34 | - energy closeness (+0.20)         |
|     |                    |               |         |   - tempo closeness (+0.09)        |
|     |                    |               |         |   - acousticness closeness (+0.05) |
+-----+--------------------+---------------+---------+------------------------------------+
|   4 | Fire in the Barrio | Sol Vega      |    0.33 | - energy closeness (+0.19)         |
|     |                    |               |         |   - tempo closeness (+0.10)        |
|     |                    |               |         |   - acousticness closeness (+0.04) |
+-----+--------------------+---------------+---------+------------------------------------+
|   5 | City Pulse Cipher  | North Avenue  |    0.32 | - energy closeness (+0.20)         |
|     |                    |               |         |   - tempo closeness (+0.08)        |
|     |                    |               |         |   - acousticness closeness (+0.04) |
+-----+--------------------+---------------+---------+------------------------------------+
